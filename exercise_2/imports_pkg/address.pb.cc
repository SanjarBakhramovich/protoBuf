...
const char descriptor_table_protodef_address_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "oto\032\014street.proto\"i\n\007Address\022\030\n\004city\030\001 \001"
  "(\0132\n.city.City\022\036\n\006street\030\002 \001(\0132\016.street."
  "Street\022$\n\010building\030\003 \001(\0132\022.building.Buil"
  "dingb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_address_2eproto = {
  false, false, descriptor_table_protodef_address_2eproto, "address.proto", 172,
...
void Address::InitAsDefaultInstance() {
  ::_Address_default_instance_._instance.get_mutable()->city_ = const_cast< ::city::City*>(
      ::city::City::internal_default_instance());
  ::_Address_default_instance_._instance.get_mutable()->street_ = const_cast< ::street::Street*>(
      ::street::Street::internal_default_instance());
  ::_Address_default_instance_._instance.get_mutable()->building_ = const_cast< ::building::Building*>(
      ::building::Building::internal_default_instance());
}
