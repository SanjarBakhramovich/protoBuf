...
static void InitDefaultsscc_info_City_city_2eproto() {
  ...
  {
    void* ptr = &::city::_City_default_instance_;
    new (ptr) ::city::City();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::city::City::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_city_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::city::City, country_name_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::city::City)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_city_2eproto = {
  false, false, descriptor_table_protodef_city_2eproto, "city.proto", 88,
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "city.City.country_name"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
// @@protoc_insertion_point(generalized_merge_from_start:city.City)
  GOOGLE_DCHECK_NE(&from, this);
  const City* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<City>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:city.City)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:city.City)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:city.City)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
